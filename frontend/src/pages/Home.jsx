    ...
    <div className="min-h-screen bg-[#0b1320] flex flex-col font-sans text-white relative overflow-hidden">
      ...
      <header className="relative z-10 bg-white/5 backdrop-blur-md border-b border-blue-500/20 shadow-lg">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4">
          ...
          <nav className="grid grid-cols-2 gap-2 w-full md:w-auto md:flex md:flex-wrap md:justify-center md:gap-4 items-center mt-4 md:mt-0">
            <Link to="/join" className="flex items-center justify-center text-center px-2 py-2.5 md:px-5 md:py-2.5 bg-white/5 md:bg-transparent rounded-lg md:rounded-full border border-white/10 md:border-transparent hover:border-blue-400/50 hover:bg-blue-500/10 text-gray-200 hover:text-white text-[13px] sm:text-sm md:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)]">Join Quiz</Link>
            <Link to="/student/dashboard" className="flex items-center justify-center text-center px-2 py-2.5 md:px-5 md:py-2.5 bg-white/5 md:bg-transparent rounded-lg md:rounded-full border border-white/10 md:border-transparent hover:border-blue-400/50 hover:bg-blue-500/10 text-gray-200 hover:text-white text-[13px] sm:text-sm md:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)]">My Events</Link>
            <Link to="/verify-certificate" className="flex items-center justify-center text-center px-2 py-2.5 md:px-5 md:py-2.5 bg-white/5 md:bg-transparent rounded-lg md:rounded-full border border-white/10 md:border-transparent hover:border-blue-400/50 hover:bg-blue-500/10 text-gray-200 hover:text-white text-[13px] sm:text-sm md:text-base font-semibold tracking-wide transition-all duration-300 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)]">Verify</Link>
            <Link to="/admin" className="flex items-center justify-center text-center px-2 py-2.5 md:px-5 md:py-2.5 bg-purple-500/20 md:bg-purple-500/10 rounded-lg md:rounded-full border border-purple-500/40 md:border-purple-500/30 hover:border-purple-400 hover:bg-purple-500/30 text-purple-100 hover:text-white text-[13px] sm:text-sm md:text-base font-bold tracking-wide transition-all duration-300 hover:shadow-[0_0_15px_rgba(168,85,247,0.4)]">Admin</Link>
          </nav>
        </div>
      </header>
